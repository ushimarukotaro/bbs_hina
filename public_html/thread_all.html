...
<div class="header__inner">
  <nav>
    <ul>
      <li><a href="./">ホーム</a></li>
      <!-- ログイン時のみ表示 -->
      <li><a href="./thread_all.html">一覧</a></li>
      <li><a href="./thread_favorite.html">お気に入り</a></li>
      <li><a href="./thread_create.html">作成</a></li>
    </ul>
  </nav>
  <!-- ログイン時のみ表示 -->
  <div class="header-r">
      <div class="prof-show" data-me=""><a href="./mypage.html"><span class="name"></span>ネコちゃん<span class="image"><img src="./gazou/img_5cfa2e5c0c60e.jpg" alt=""></span></a></div>
      <form action="logout.html" id="logout" class="user-btn">
...
<form action="thread_search.html" class="form-group form-search">
...
<ul class="thread">
    <li class="thread__item">
      ...
      <div class="operation">
        <a href="./thread_disp.html">書き込み&amp;すべて読む(2)</a>
    ...
    <li class="thread__item">
      ...
      <ul class="thread__body">
        ...
        <div class="operation">
          <a href="./thread_disp.html">書き込み&amp;すべて読む(3)</a>
          <p class="thread__date">スレッド作成日時：2019-06-10 16:03:01</p>
        </div>
      </ul>
    </li>
